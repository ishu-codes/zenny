...
import { ArrowLeftRight, BadgeCheck, FileOutput, User } from "lucide-react";
      ...
      {!currentTransaction ? (
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-4 gap-12 px-10">
            {Array.from({ length: 4 }, (_, i) => i).map((idx) => (
              <Skeleton className="w-12 h-12" key={idx} />
            ))}
          </div>

          <Skeleton className="w-20 h-8 mt-12" />
        ...
        <>
          ...
          <div className="mt-4 flex flex-col">
            <p>Actions</p>
            <div className="w-full pt-3 grid grid-cols-4 gap-6">
              {[
                {
                  name: "type",
